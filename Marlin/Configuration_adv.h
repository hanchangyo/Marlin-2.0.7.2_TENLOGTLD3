...
#define X2_MIN_POS 15          // Set a minimum to ensure the  second X-carriage can't hit the parked first X-carriage
#define X2_MAX_POS 379         // Set this to the distance between toolheads when both heads are homed
